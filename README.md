...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-05-22 12:39`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/637d94ef-ef32-46a3-a668-902c7cde6fc5.git
$ cd 637d94ef-ef32-46a3-a668-902c7cde6fc5
```
